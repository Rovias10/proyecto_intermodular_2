...
if (document.getElementById("dashboardStats")) {
    async function cargarDashboardStats() {
        try {
            ...
            document.getElementById("statTotalProjects").textContent = stats.totalProjects || 0;
            document.getElementById("statTasksPending").textContent = stats.tasksPending || 0;
            document.getElementById("statTasksCompleted").textContent = stats.tasksCompleted || 0;
        } catch (error) {
    ...
    async function cargarProyectos() {
        try {
            ...
            if (projects.length === 0) {
                grid.innerHTML = '<div class="col-12"><p>No tienes proyectos. ¡Crea uno!</p></div>';
                return;
            }
